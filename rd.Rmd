...
<h4>Usage</h4>
<pre class="r"><code>fit_trajectory(dat, x_var = "agedays", y_var = "htcm", method = "fda",
...
<dl class="rd-dl">
  ...
  <dt>method</dt>
  <dd class="rd-dd">one of "fda", "gam", "loess", "rlm", "face"</dd>
  <dt>xg</dt>
...
<h4>Examples</h4>
<pre class="r"><code>fit <- fit_trajectory(subset(cpp, subjid == 2), y_var = "wtkg")
...
<pre class="r"><code>fit_all_trajectories(dat, subjid = "subjid", x_var = "agedays",
  y_var = "htcm", method = "fda", checkpoints = 365 * c(1:2),
...
<dl class="rd-dl">
  ...
  <dd class="rd-dd">name of y variable to model</dd>
  <dt>method</dt>
  <dd class="rd-dd">one of "fda", "gam", "loess", "rlm"</dd>
  <dt>checkpoints</dt>
  <dd class="rd-dd">x values at which to compute "checkpoints" of the subjectss growth trajectory to compare to other subjects</dd>
  <dt>z_bins</dt>
  <dd class="rd-dd">a vector indicating binning of z-scores for the subjects trajectory at each checkpoint with respect to the the WHO growth standard</dd>
...
<h4>Usage</h4>
<pre class="r"><code>fit_methodfda(dat, xg = NULL, cpx = NULL, lambda = 0.1, ...)</code></pre>
...
<dl class="rd-dl">
  ...
  <dd class="rd-dd">x values at which to compute "checkpoints" of the fitted subjectss growth trajectory to compare to other subjects</dd>
  <dt>lambda</dt>
  <dd class="rd-dd">smoothing parameter passed to <code><a href=http://www.inside-r.org/packages/cran/fda/docs/smooth.basisPar>smooth.basisPar</a></code></dd>
  <dt>...</dt>
  <dd class="rd-dd">additional parameters passed to <code><a href=http://www.inside-r.org/packages/cran/fda/docs/smooth.basisPar>smooth.basisPar</a></code></dd>
</dl>
...
<h3>Get the result of fitting face.sparse to a data set</h3>


<h4>Usage</h4>
<pre class="r"><code>get_face_fit(dat, x_var = "agedays", y_var = "htcm", knots = 10,
  x_trans = NULL, y_trans = NULL, ...)</code></pre>
...
<dl class="rd-dl">
  ...
  <dd class="rd-dd">data frame containing variables to model</dd>
  <dt>x_var</dt>
  <dd class="rd-dd">name of x variable to model (default "agedays")</dd>
  <dt>y_var</dt>
  <dd class="rd-dd">name of y variable to model (default "htcm")</dd>
  <dt>knots</dt>
  <dd class="rd-dd">number of knots, sent to <code><a href=http://www.inside-r.org/packages/cran/face/docs/select_knots>select_knots</a></code></dd>
  <dt>x_trans, y_trans</dt>
  <dd class="rd-dd">transformation functions to be applied to x and y prior to modeling (see note)</dd>
  <dt>...</dt>
  <dd class="rd-dd">additional parameters passed to <code><a href=http://www.inside-r.org/packages/cran/face/docs/face.sparse>face.sparse</a></code></dd>
</dl>

  <h4>Details</h4>

  <p class="rd-p">This essentially gets an anthropometric data set into shape for <code><a href=http://www.inside-r.org/packages/cran/face/docs/face.sparse>face.sparse</a></code> (sets appropriate data structure and removes missing values) and runs the fitting routine.</p>
...
<h4>Examples</h4>
<pre class="r"><code>facefit <- get_face_fit(cpp, y_var = "wtkg")
...
<h3>Compute fpca "face" fit of growth trajectory</h3>


<h4>Usage</h4>
<pre class="r"><code>fit_methodface(dat, xg = NULL, cpx = NULL, fit)</code></pre>
...
<dl class="rd-dl">
  ...
  <dd class="rd-dd">x values at which to compute "checkpoints" of the fitted subjectss growth trajectory to compare to other subjects</dd>
  <dt>fit</dt>
  <dd class="rd-dd">the result of running <code><a href=http://www.inside-r.org/packages/cran/face/docs/face.sparse>face.sparse</a></code> against the entire data set (with convenience wrapper <code><a href=#get_face_fit>get_face_fit</a></code>) which is used to compute per-subject fits</dd>
</dl>
