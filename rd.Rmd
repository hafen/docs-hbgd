...
<h4>Usage</h4>
<pre class="r"><code>fit_trajectory(dat, fit, xg = NULL, checkpoints = 365 * c(1:2),
  z_bins = -2)</code></pre>
...
<h4>Usage</h4>
<pre class="r"><code>fit_all_trajectories(dat, fit, xg = NULL, checkpoints = 365 * c(1:2),
  z_bins = -2)</code></pre>
...
<h4>Examples</h4>
<pre class="r"><code>cppfit <- get_fit(cpp, y_var = "wtkg", method = "rlm")
cpptr  <- fit_all_trajectories(cpp, cppfit)
cpptr[[1]]
plot(cpptr[[1]]$value)</code></pre>
...
cppplot <- trscope_trajectories(cpptr)</code></pre>
...
cppfit  <- get_fit(cpp, method = "rlm")
cpptr   <- fit_all_trajectories(cppsubj, cppfit)
cppplot <- trscope_velocities(cpptr)</code></pre>
...
cppfit  <- get_fit(cpp, method = "rlm")
cpptr   <- fit_all_trajectories(cppsubj, cppfit)
cppcp   <- by_trajectory_checkpoints(cpptr)</code></pre>
