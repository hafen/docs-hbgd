...
<h4>Usage</h4>
<pre class="r"><code>plot_z(x, x_range = NULL, nadir = TRUE, width = 500, height = 520,
...
<dl class="rd-dl">
  ...
  <dt>knots</dt>
  <dd class="rd-dd">number of knots, sent to <code><a href=http://www.inside-r.org/packages/cran/face/docs/select.knots>select.knots</a></code></dd>
  <dt>x_trans, y_trans</dt>
