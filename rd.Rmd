...
<p><strong>Authors:</strong> <a href="mailto:rhafen@gmail.com">Ryan Hafen</a> [aut, cre],<a href="mailto:craig.anderson@uts.edu.au">Craig Anderson</a> [ctb]</p>
...
<h3>Check a dataset to ensure it will be compatible with hbgd methods</h3>


<h4>Usage</h4>
<pre class="r"><code>check_data(dat, has_height = TRUE, has_weight = TRUE, has_hcir = TRUE)</code></pre>
...
<dl class="rd-dl">
  ...
  <dt>has_height</dt>
  <dd class="rd-dd">does this data set contain anthropometric height data?</dd>
  <dt>has_weight</dt>
  <dd class="rd-dd">does this data set contain anthropometric weight data?</dd>
  <dt>has_hcir</dt>
  <dd class="rd-dd">does this data set contain anthropometric head circumference data?</dd>
</dl>


<h4>Examples</h4>
<pre class="r"><code>check_data(cpp, has_hcir = FALSE)
...
<h3>Add indicator column for per-subject holdout</h3>


<h4>Usage</h4>
<pre class="r"><code>add_holdout_ind(dat, random = TRUE)</code></pre>
...
<h3>View known hbgd variables</h3>
...
<h4>Usage</h4>
<pre class="r"><code>get_data_attributes(dat, meta = NULL, study_meta = NULL)</code></pre>
...
<h3>Obtain a trajectory "fit" object for a data set</h3>


<h4>Usage</h4>
<pre class="r"><code>get_fit(dat, x_var = "agedays", y_var = "htcm", method = "fda",
  xg = NULL, checkpoints = 365 * c(1:2), z_bins = -2, holdout = FALSE,
...
<h3>Apply a model fit to an individual's trajectory</h3>


<h4>Usage</h4>
<pre class="r"><code>fit_trajectory(dat, fit)</code></pre>
...
<h4>Usage</h4>
<pre class="r"><code>fit_all_trajectories(dat, fit)</code></pre>
...
<h4>Examples</h4>
<pre class="r"><code>cppt <- fit_all_trajectories(cpp, y_var = "wtkg")
cppt[[1]]
...
<h3>Get MSE for holdout</h3>


<h4>Usage</h4>
<pre class="r"><code>get_fit_holdout_mse(d, z = TRUE)</code></pre>
...
<h4>Usage</h4>
<pre class="r"><code>plot_z(x, x_range = NULL, nadir = FALSE, width = 500, height = 520,
  hover = NULL, checkpoints = TRUE, z = -3:0, ...)</code></pre>
...
<h3>Get names of all available fitting methods</h3>
...
<h3>Compute gam spline fit of growth trajectory</h3>


<h4>Usage</h4>
<pre class="r"><code>fit_methodgam(dat, ...)</code></pre>
...
<h4>Usage</h4>
<pre class="r"><code>fit_methodloess(dat, ...)</code></pre>
...
<dl class="rd-dl">
  ...
  <dd class="rd-dd">data frame specifying x and y coordinates of data to fit</dd>
  <dt>...</dt>
  <dd class="rd-dd">additional parameters passed to <code><a href=http://www.inside-r.org/r-doc/stats/loess>loess</a></code>, notably <code>span</code>, <code>degree</code>, and <code>family</code></dd>
</dl>
...
<h4>Usage</h4>
<pre class="r"><code>fit_methodrlm(dat, ...)</code></pre>
...
<dl class="rd-dl">
  ...
  <dd class="rd-dd">data frame specifying x and y coordinates of data to fit</dd>
  <dt>...</dt>
  <dd class="rd-dd">additional parameters passed to <code><a href=http://www.inside-r.org/r-doc/MASS/rlm>rlm</a></code>, also <code>p</code> which is the order of polynomial fit (default is quadratic, p=2)</dd>
</dl>
...
<h3>Compute functional "fda" fit of growth trajectory</h3>


<h4>Usage</h4>
<pre class="r"><code>fit_methodfda(dat, ...)</code></pre>
...
<dl class="rd-dl">
  ...
  <dd class="rd-dd">data frame specifying x and y coordinates of data to fit</dd>
  <dt>...</dt>
  <dd class="rd-dd">additional parameters passed to <code><a href=http://www.inside-r.org/packages/cran/fda/docs/smooth.basisPar>smooth.basisPar</a></code>, notably <code>lambda</code> which defaults to 0.1</dd>
</dl>
...
<h3>Get the result of fitting brokenstick to a data set</h3>


<h4>Usage</h4>
<pre class="r"><code>fit_methodbrokenstick(dat, ...)</code></pre>
...
<dl class="rd-dl">
  ...
  <dd class="rd-dd">data frame containing variables to model</dd>
  <dt>...</dt>
  <dd class="rd-dd">additional parameters passed to <code><a href=http://www.inside-r.org/packages/cran/brokenstick/docs/brokenstick>brokenstick</a></code>, most notably <code>knots</code></dd>
</dl>

  <h4>Details</h4>

  <p class="rd-p">This essentially gets an anthropometric data set into shape for <code><a href=http://www.inside-r.org/packages/cran/brokenstick/docs/brokenstick>brokenstick</a></code> (sets appropriate data structure and removes missing values) and runs the fitting routine.</p>
...
<h4>Examples</h4>
<pre class="r"><code>bsfit <- get_fit(cpp, y_var = "haz", method = "brokenstick")
...
<h3>Get the result of fitting a Laird and Ware linear or quadratic model to a data set</h3>


<h4>Usage</h4>
<pre class="r"><code>fit_methodlwmod(dat, ...)</code></pre>
...
<dl class="rd-dl">
  ...
  <p class="rd-p">This essentially gets an anthropometric data set into shape for <code><a href=http://www.inside-r.org/packages/cran/sitar/docs/sitar>sitar</a></code> (sets appropriate data structure and removes missing values) and runs the fitting routine.</p>
...
<h4>Examples</h4>
<pre class="r"><code>lwfit <- get_fit(cpp, y_var = "haz", method = "lwmod", deg = 2)
...
<h3>Get the result of fitting sitar to a data set</h3>


<h4>Usage</h4>
<pre class="r"><code>fit_methodsitar(dat, ...)</code></pre>
...
<dl class="rd-dl">
  ...
  <dd class="rd-dd">data frame containing variables to model</dd>
  <dt>...</dt>
  <dd class="rd-dd">additional parameters passed to <code><a href=http://www.inside-r.org/packages/cran/sitar/docs/sitar>sitar</a></code>, most notably <code>df</code> which defaults to 3</dd>
</dl>
...
<h4>Examples</h4>
<pre class="r"><code>sitfit <- get_fit(cpp, y_var = "haz", method = "sitar")
...
<h3>Compute smooth.spline fit of growth trajectory</h3>


<h4>Usage</h4>
<pre class="r"><code>fit_methodsmooth.spline(dat, ...)</code></pre>
...
<dl class="rd-dl">
  ...
  <dd class="rd-dd">data frame specifying x and y coordinates of data to fit</dd>
  <dt>...</dt>
  <dd class="rd-dd">additional parameters passed to <code><a href=http://www.inside-r.org/r-doc/stats/smooth.spline>smooth.spline</a></code></dd>
</dl>
...
<h3>Get the result of fitting a "Wand" model to a data set</h3>


<h4>Usage</h4>
<pre class="r"><code>fit_methodwand(dat, ...)</code></pre>
...
<h4>Examples</h4>
<pre class="r"><code>wfit <- get_fit(cpp, y_var = "haz", method = "lwmod", deg = 2)
...
<h4>Usage</h4>
<pre class="r"><code>plot_first_visit_age(dat, agelab = "first visit age (days)", width = 450,
  height = 450)</code></pre>
...
<h4>Usage</h4>
<pre class="r"><code>plot_visit_distn(dat, width = 450, height = 450)</code></pre>
...
<h4>Usage</h4>
<pre class="r"><code>plot_var_matrix(dat_list, width = 845, h_padding = 0, head = NULL)</code></pre>
...
<h4>Usage</h4>
<pre class="r"><code>plot_multi_subj_boxplot(dat_list, width = 800, height = 500)</code></pre>
...
<h4>Usage</h4>
<pre class="r"><code>plot_time_count_grid(dat_list, xlab = "Age since birth at examination (days)",
  width = 845, height = 120, y_margin = 100)</code></pre>
...
<h3>Create Trelliscope display of per-subject data and fitted trajectories</h3>


<h4>Usage</h4>
<pre class="r"><code>trscope_trajectories(dat, z = FALSE, center = FALSE, x_range = NULL,
  width = 500, height = 520, name = NULL, desc = "", group = NULL,
  vdbConn = getOption("vdbConn"))</code></pre>
...
<pre class="r"><code>  cppsubj <- by_subject(cpp)
  ...
  cpptr <- trscope_trajectories(cppt)</code></pre>



## trscope_velocities

<h3>Create Trelliscope display of the velocities of per-subject fitted trajectories</h3>


<h4>Usage</h4>
<pre class="r"><code>trscope_velocities(dat, z = FALSE, x_range = NULL, width = 500,
...
<pre class="r"><code>  cppsubj <- by_subject(cpp)
  cppt <- fit_all_trajectories(cppsubj, method = "rlm")
  cppt <- trscope_velocities(cppt)</code></pre>
...
<h4>Usage</h4>
<pre class="r"><code>by_subject(dat)</code></pre>
...
<h3>Get SMOCC data from brokenstick, transformed to be hbgd-compatible</h3>


<h4>Usage</h4>
<pre class="r"><code>get_smocc_data()</code></pre>
...
<h3>Get the x-axis range across all subjects</h3>


<h4>Usage</h4>
<pre class="r"><code>get_x_range(dat, pad = 0.07)</code></pre>
...
<h4>Usage</h4>
<pre class="r"><code>get_agefreq(dat, age_range = NULL)</code></pre>
...
<h3>Get nadir of a growth velocity</h3>


<h4>Usage</h4>
<pre class="r"><code>get_nadir(obj)</code></pre>
