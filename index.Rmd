...
The Bioconductor repository is added because some of the fitting methods linked to in 'hbgd'  have dependencies on Bioconductor packages.
...
smc_tr <- fit_all_trajectories(cpp, facefit)
```
